...
session_start();
//koneksi ke database
   $koneksi =  new mysqli("localhost", "root" , "", "pusatnyadurian");
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">DURIAN CREW</a>
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                ...
                <li class="text-center">
                    <img src="PROFIL.png" class="user-image img-responsive" width="200" height="200"/>
                    </li>
